...
class XDesign{
  function __construct() {
    ...
    function fn_setPath(){       
      ...
      $this->str_name_app_xdesign="xdesign";         
      ...
      $this->str_folderPathComponentXDesign=$this->fn_getFolderPathComponent();                          
      ...
      $this->str_name_file_project="project.mjs";
    ...
    function fn_getFolderPathComponent(){    
      return $this->str_path_folder_build."/".$this->str_name_folder_component;                
    }        
    function fn_getFolderPathComponentRecord($str_name_component){          
      return $this->fn_getFolderPathComponent()."/".$str_name_component;    
    }        
    ...
    function fn_createPackageFolder($str_name_app, $int_idRecord, $bln_delete=false){
      ...
      //str_folderPathVersionApp
      $str_path=$obj_path->str_folderPathPackageVersion."/".$this->str_name_folder_app;            
      $this->fn_createFolder($str_path);       
      $obj_path->str_folderPathVersionApp=$str_path;      
      //str_folderPathVersionApp
      
      //str_folderPathVersionApp
      $str_path=$obj_path->str_folderPathVersionApp."/".$str_name_app;          
      $this->fn_createFolder($str_path); 
      $obj_path->str_folderPathVersionApp=$str_path;            
      //str_folderPathVersionApp

      //str_folderPathVersionRucksack
      $str_path=$obj_path->str_folderPathVersionApp."/".$this->str_name_folder_rucksack;                                      
      $this->fn_createFolder($str_path); 
      $obj_path->str_folderPathVersionRucksack=$str_path;            
      
      //COPY APP FOLDER FROM WAREHOUSE ROOT TO VERSION ROOT      
      $str_source=$this->str_path_folder_app."/".$str_name_app;                
      $str_destination=$obj_path->str_folderPathVersionApp;
    ...
    function fn_packageProject($obj_ini){  
      ...
      $obj_path=$this->fn_createPackageFolder($str_nameComponent, $int_idRecord, true);               
...
heredoc;  
      ...
      //Write Code to File      
      $this->str_path_file_index=$obj_path->str_folderPathVersionRucksack."/".$this->str_name_file_index;            
      file_put_contents($this->str_path_file_index, $str_documentIndex);               
      
      $str_path_file_xdesign=$obj_path->str_folderPathVersionRucksack."/".$this->str_name_file_project;            
      ...
      $this->fn_copyFolder($obj_path->str_folderPathVersionRucksack, $obj_path->str_folderPathPackageVersion);            
      $this->fn_deleteFolder($obj_path->str_folderPathVersionRucksack);            
      return;
      ...
      if($bln_release){
        ...
        $str_path_folder_release=$str_path_folder_release_parent."/".$this->str_name_folder_version;    
        $this->fn_deleteFolder($str_path_folder_release);                    
        $this->fn_createFolder($str_path_folder_release);          
        $this->fn_copyFolder($obj_path->str_folderPathPackageVersion, $str_path_folder_release); 
      }
...
function fn_XDesigner_move(){
  ...
  $obj_path=$this->fn_createPackageFolder($this->str_name_app_xdesign, $int_idRecord, false);
  
  $str_path_destination_rucksack=$this->str_path_document_root;    
  $this->fn_copyFolder($obj_path->str_folderPathVersionRucksack, $str_path_destination_rucksack);        
  
  
  /*
  $str_path_destination_app=$this->str_path_document_root."/".$this->str_name_folder_app;  
  $this->fn_createFolder($str_path_destination_app); 

  $str_path_destination_app_xdesign=$str_path_destination_app."/".$this->str_name_app_xdesign;    
  $this->fn_createFolder($str_path_destination_app_xdesign);     
  
  $str_path_destination_asset=$str_path_destination_app_xdesign."/".$this->str_name_folder_asset;    
  //$this->fn_deleteFolder($str_path_destination_asset);    
  //$this->fn_copyFolder($this->str_name_folder_asset, $obj_path->str_folderPathVersionApp, $str_path_destination_app_xdesign);  

  $str_path_destination_component=$str_path_destination_app_xdesign."/".$this->str_name_folder_component;    
  //$this->fn_deleteFolder($str_path_destination_component);    
  //$this->fn_copyFolder($this->str_name_folder_component, $obj_path->str_folderPathVersionApp, $str_path_destination_app_xdesign);  

  $str_path_destination_server=$str_path_destination_app_xdesign."/".$this->str_name_folder_server;    
  //$this->fn_deleteFolder($str_path_destination_server);    
  //$this->fn_copyFolder($this->str_name_folder_server, $obj_path->str_folderPathVersionApp, $str_path_destination_app_xdesign);       
  //*/
  
  /*
  $this->str_name_folder_compile="compile";  
  $str_path_destination_compile=$str_path_destination_app."/".$this->str_name_folder_compile;    
  //$this->fn_deleteFolder($str_path_destination_compile);  
  //$this->fn_createFolder($str_path_destination_compile);    
  //$this->fn_copyFolder($this->str_name_folder_compile, $obj_path->str_folderPathInstanceRecord, $str_path_destination_app);       
  //*/
}
...
function fn_importInstanceFiles(){
  ...
  foreach ($arr_fobj as $str_name) {  
    ...
    $str_file_path=$this->fn_getFilePathInstanceRecordColumn($int_idRecord, "HiddenProjectPin");        
    ...
    $str_file_path=$this->fn_getFilePathInstanceRecordColumn($int_idRecord, "HiddenPalettePin");                        
