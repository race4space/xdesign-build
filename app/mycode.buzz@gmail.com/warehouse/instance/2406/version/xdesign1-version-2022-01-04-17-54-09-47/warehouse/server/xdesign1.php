...
class XDesign{
  function __construct() {
      ...
      $this->bln_debugPath=true;
      $this->bln_debugPathProjectInstance=true;
    ...
    function fn_setPath(){ 
      ...
      $this->str_name_folder_client="client";       
    ...
    function fn_debugPath(){
      ...
      $s.="this->str_path_folder_warehouse: ".$this->str_path_folder_warehouse.PHP_EOL.PHP_EOL;
      $s.="this->str_path_folder_server: ".$this->str_path_folder_server.PHP_EOL.PHP_EOL;
      $s.="this->str_path_folder_asset: ".$this->str_path_folder_asset.PHP_EOL.PHP_EOL;      
      $s.="this->str_path_folder_component: ".$this->str_path_folder_component.PHP_EOL.PHP_EOL;
      $s.="this->str_path_folder_instance: ".$this->str_path_folder_instance.PHP_EOL.PHP_EOL;      
      $this->fn_addEcho($s);     
    ...
    function fn_set(){          
      ...
      $this->str_path_folder_user_resource=$this->str_path_folder_warehouse;
    ...
    function fn_setfolderpathProjectInstance(){      
      ...
      $this->folderpath_buildInstance=$this->folderpath_build."/".$this->xdesign_module_name;                        
      $this->URLProjectInstance=$this->path2url($this->folderpath_buildInstance);      
    ...
    function fn_debugPathProjectInstance(){
      ...
      $s.="this->folderpath_buildInstance: ".$this->folderpath_buildInstance.PHP_EOL.PHP_EOL;      
    ...
    function fn_getfolderpathInstance($int_idRecord){
      ...
      return $this->str_path_folder_instance."/".$int_idRecord;      
    }
    
    function fn_getfolderpathComponent($db_type){

      return $this->str_path_folder_component."/".$db_type;      
    }
    ...
    function fn_versionComponent(){
      ...
      $this->fn_deleteFolder($this->folderpath_version);
      //remove existing version files       
    ...
    function fn_buildProject($obj_ini){     
      ...
      $str_path_folder_target=$this->folderpath_buildInstance;      
      if($bln_version){
        $str_name_file_xdesign=$this->str_name_file_xdesign_version;
        $str_path_folder_target=$this->folderpath_projectVersion;      
      }         


      $str_path_folder_instance=$this->fn_getfolderpathInstance($int_idRecord);              
      $this->fn_createFolder($str_path_folder_instance);            

      $str_path_folder_instance_client=$str_path_folder_instance."/".$this->str_name_folder_client;                          
      $this->fn_deleteFolder($str_path_folder_instance_client);
      $this->fn_createFolder($str_path_folder_instance_client);       
      
      $str_path_folder_instance_build=$str_path_folder_instance."/".$this->str_name_folder_build;                                
      $this->fn_deleteFolder($str_path_folder_instance_build);

      $str_path_folder_instance_version=$str_path_folder_instance."/".$this->str_name_folder_version;                                
      $this->fn_deleteFolder($str_path_folder_instance_version);

      $this->fn_createFolder($str_path_folder_target);
...
heredoc;  
      ...
      //Write Code to File      
      $this->str_path_file_index=$str_path_folder_instance_client."/".$this->str_name_file_xdesign_index;            
      file_put_contents($this->str_path_file_index, $str_documentIndex);               
      
      $str_path_file_xdesign=$str_path_folder_instance_client."/".$str_name_file_xdesign;            
      ...
      $this->fn_transferFolderContent($this->str_name_folder_client, $str_path_folder_instance, $str_path_folder_target);      
      $this->fn_copyFolder($this->str_name_folder_warehouse, $str_path_folder_instance, $str_path_folder_target);           
      $this->fn_transferFolderContent($this->str_name_folder_rucksack, $str_path_folder_instance, $str_path_folder_target);      
    ...
    function fn_copyFolder($str_name_folder, $str_path_source_parent, $str_path_destination_parent){      

      $str_path_source=$str_path_source_parent."/".$str_name_folder;
      $bln_fileexist=file_exists($str_path_source);                   
      if($bln_fileexist){                    
        $str_path_destination=$str_path_destination_parent."/".$str_name_folder;
        $this->fn_copyFolderContent($str_path_source, $str_path_destination);
      }  
    }
    
    function fn_transferFolderContent($str_name_folder, $str_path_source_parent, $str_path_destination_content){
      
      $str_path_source=$str_path_source_parent."/".$str_name_folder;
      $bln_fileexist=file_exists($str_path_source);                   
      if($bln_fileexist){                            
        $this->fn_copyFolderContent($str_path_source, $str_path_destination_content);
      }  
    }
...
function fn_releaseComponent($int_idRecord, $str_nameRelease){  
  ...
  $this->str_path_folder_release=dirname($this->str_path_document_root);
  ...
  $this->fn_deleteFolder($this->str_path_folder_release_target);      
...
function fn_XDesigner_create_path_release_app_asset(){  
  ...
  $str_path_source=$this->str_path_folder_asset;  
...
function fn_XDesigner_create_path_release_app_resource(){  
  ...
  $this->str_path_folder_release_app_resource=$this->str_path_folder_release_app."/".$this->str_name_folder_warehouse;
...
function fn_XDesigner_create_path_release_app_server(){
  ...
  $str_path_source=$this->str_path_folder_server;  
...
function fn_copyFolderContent($source, $dest, $bln_recur=true)
{
    ...
    while (false !== $entry = $dir->read()) {
        ...
        if($bln_recur){
          $this->fn_copyFolderContent("$source/$entry", "$dest/$entry", $bln_recur);
        }
...
function fn_XDesigner_compile(){
  ...
  $this->str_folder_path_compile=$this->str_path_folder_warehouse."/".$this->str_folder_name_compile;  
...
function fn_importComponentFiles(){
  ...
  //for each strname_component_folder in $this->str_path_folder_component;
  
  $arr_fobj = scandir($this->str_path_folder_component);
...
function fn_removeBuildFolderInstance(){
  ...
  //for each strname_instance_folder in $this->str_path_folder_instance;
  $arr_fobj = scandir($this->str_path_folder_instance);
...
function fn_removeOrphanFolder($int_idRecord){
  ...
  $str_path=$this->str_path_folder_instance."/".$int_idRecord;  
...
function fn_importInstanceFiles(){
  ...
  foreach ($arr_fobj as $str_name) {  
    ...
    $str_path=$this->str_path_folder_instance."/".$str_name;
    if(!is_dir($str_path)){
      continue;
    }
...
function fn_get_folder_path_component($str_name_component){    
  ...
  $str_path_folder=$this->str_path_folder_component."/".$str_name_component;       
...
function fn_get_folder_path_instance_file($str_name_instance){    
  ...
  $str_path_folder=$this->str_path_folder_instance."/".$str_name_instance;       
